...
class MetricsTestModel(DatazillaModelBase):
    ...
    def get_parent_test_data(
        ...
        position of the child looking for the parent push of 'child_key'.

        pushlog - Pushlog data structure for a given branch (generated by
            PushLogModel.get_branch_pushlog.

        index - Pushlog index where the child is found to start
            walking from.

        child_key - Metrics key of the child to find a parent for.
