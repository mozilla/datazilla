...
ColVis.prototype = {
	...
	"_fnConstruct": function ()
	{
      ...
      //Jeads - Added a title on mouse over to the column dropdown icon
      this.dom.wrapper.title = 'Toggle Column Visibility';
	...
	"_fnCollectionShow": function ()
	{
		...
		if ( this.s.sSize == "auto" )
		{
         ...
         //Jeads - Added a 50 pixel buffer for the column name drop down
			iMax = Math.max.apply(window, aiSizes) + 50;
			for ( i=0, iLen=this.dom.buttons.length ; i<iLen ; i++ )
			{
				if ( this.dom.buttons[i] !== null )
				{
